...
if [ ! -f "$BUILD_DIR/tests/crypto_tests" ]; then
    echo "Error: Test binary not found at $BUILD_DIR/tests/crypto_tests"
    ...
    echo "  cmake --build $BUILD_DIR --target crypto_tests"
    exit 1
fi
...
echo ""
echo "============================================================"
echo "Coverage Report - crypto Module"
echo "============================================================"
echo ""
